...
class InsertDogImageUrlUseCase @Inject constructor(private val repository: DogImageRepository) {

    fun execute(imageUrl: DogImageUrl) = repository.insert(imageUrl)
}
